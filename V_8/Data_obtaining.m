...
save ('NATRRate','NATRRate')
save ('NATRLoad','NATRLoad')
save ('NATRExtension','NATRExtension')
save ('NRRate','NRRate')
save ('NRLoad','NRLoad')
save ('NRExtension','NRExtension')
save ('FRRate','FRRate')
save ('FRLoad','FRLoad')
save ('FRExtension','FRExtension')
save ('EPRRate','EPRRate')
save ('EPRLoad','EPRLoad')
save ('EPRExtension','EPRExtension')
