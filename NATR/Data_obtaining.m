...
path{:,1} = '.\NatR\RDSO NatR Tensile 50.is_tens_RawData\Specimen_RawData_';
path{:,2} = '.\NatR\RDSO NatR Tensile 250.is_tens_RawData\Specimen_RawData_';
path{:,3} = '.\NatR\RDSO NatR Tensile 500.is_tens_RawData\Specimen_RawData_';
x = 1;
rates = 3;
files = [11 5 1];
path2 = '.csv';
